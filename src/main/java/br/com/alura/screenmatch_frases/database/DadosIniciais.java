package br.com.alura.screenmatch_frases.database;
...
public class DadosIniciais {
  ...
  @Bean
  CommandLineRunner carregarFrases(FraseRepository repository) {
    return _ -> {
      ...
      if (repository.count() == 0) {
        repository.saveAll(List.of(
            ...
            new Frase(
                ...
                "George Contanza",
                "Seinfeld",
                "https://m.media-amazon.com/images/M/MV5BZjZjMzQ2ZmUtZWEyZC00NWJiLWFjM2UtMzhmYzZmZDcxMzllXkEyXkFqcGdeQXVyNTA4NzY1MzY@._V1_SX300.jpg"
            ),
            new Frase(
                null,
                ...
                "Meredith Grey",
                "Grey's Anatomy",
                "https://m.media-amazon.com/images/M/MV5BODA2Mjk0N2MtNGY0Mi00ZWFjLTkxODEtZDFjNDg4ZDliMGVmXkEyXkFqcGdeQXVyMzAzNTY3MDM@._V1_SX300.jpg"
            ),
            new Frase(
                null,
                ...
                "Walter White",
                "Breaking Bad",
                "https://m.media-amazon.com/images/M/MV5BYTU3NWI5OGMtZmZhNy00MjVmLTk1YzAtZjA3ZDA3NzcyNDUxXkEyXkFqcGdeQXVyODY5Njk4Njc@._V1_SX300.jpg"
            ),
            new Frase(
                null,
            ...
            new Frase(
                ...
                "https://m.media-amazon.com/images/M/MV5BNTVkMTFiZWItOTFkOC00YTc3LWFhYzQtZTg3NzAxZjJlNTAyXkEyXkFqcGdeQXVyODE5NzE3OTE@._V1_SX300.jpg"
            )
        ));
      }
    };
